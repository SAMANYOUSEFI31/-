...
| 3-Column Habit Cards Grid | `grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3` | **layout-wrapper** | *None (invisible)* | already tokenized |
| Interactive Habit Card | `p-3 sm:p-3.5 radius-card border text-right transition-all flex items-center justify-between gap-3 group cursor-pointer active:scale-[0.98] focus-ring-tactical [bg-emerald-subtle border-emerald-subtle / surface-z1 border-standard hover:border-[var(--color-border-hover)]]` | **control** (card surface) | `radius-card`, `bg-emerald-subtle`, `border-emerald-subtle`, `surface-z1`, `border-standard`, `hover:border-[var(--color-border-hover)]`, `focus-ring-tactical` | already tokenized |
| Habit Icon Well | `w-9 h-9 sm:w-10 sm:h-10 radius-component border flex items-center justify-center shrink-0 transition-colors [bg-emerald-subtle text-emerald border-emerald-subtle / surface-z2 text-role-muted border-standard]` | **control** (well) | `radius-component`, `surface-z2`, `border-standard`, `bg-emerald-subtle`, `border-emerald-subtle` | already tokenized |
| Habit Checkbox Indicator | `w-6 h-6 sm:w-7 sm:h-7 rounded-full border flex items-center justify-center transition-colors shrink-0 [bg-emerald-subtle border-emerald text-emerald / border-standard surface-z2 group-hover:border-[var(--color-border-hover)]]` | **control** (checkbox) | `border-standard`, `surface-z2`, `bg-emerald-subtle`, `border-emerald`, `text-emerald` | already tokenized |
...
| Section Container Wrapper | `space-y-2.5 sm:space-y-3` | **layout-wrapper** | *None (invisible)* | already tokenized |
| Section Header Bar | `flex flex-wrap items-center justify-between gap-2 px-1` | **layout-wrapper** | *None (invisible)* | already tokenized |
| Interactive Mission Button | `w-full p-3 sm:p-3.5 radius-card border text-right transition-all flex items-center justify-between gap-3 group cursor-pointer active:scale-[0.98] focus-ring-tactical [bg-amber-subtle border-amber-subtle / surface-z1 border-standard hover:border-[var(--color-border-hover)]]` | **control** (card surface) | `radius-card`, `bg-amber-subtle`, `border-amber-subtle`, `surface-z1`, `border-standard`, `hover:border-[var(--color-border-hover)]`, `focus-ring-tactical` | already tokenized |
| Mission Icon Well | `w-9 h-9 sm:w-10 sm:h-10 radius-component border flex items-center justify-center shrink-0 transition-colors [bg-amber-subtle text-amber border-amber-subtle / surface-z2 text-role-muted border-standard]` | **control** (well) | `radius-component`, `surface-z2`, `border-standard`, `bg-amber-subtle`, `border-amber-subtle` | already tokenized |
| +2 Score Badge | `text-[10px] px-2 py-0.5 rounded-full font-bold font-mono border shrink-0 [bg-amber-subtle text-amber border-amber-subtle / surface-z2 text-role-secondary border-standard]` | **control** (pill) | `bg-amber-subtle`, `border-amber-subtle`, `text-amber`, `surface-z2`, `border-standard` | already tokenized |
| Mission Checkbox Indicator | `w-6 h-6 sm:w-7 sm:h-7 rounded-full border flex items-center justify-center transition-colors shrink-0 [bg-amber-subtle border-amber text-amber / border-standard surface-z2 group-hover:border-[var(--color-border-hover)]]` | **control** (checkbox) | `border-standard`, `surface-z2`, `bg-amber-subtle`, `border-amber`, `text-amber` | already tokenized |
