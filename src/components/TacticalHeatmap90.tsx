      ...
      if (isToday) {
        if (computed && computed.statusType === 'standard') {
          if (computed.score === 10) {
            bgClass = 'bg-amber text-black border-amber font-black shadow-subtle ring-2 ring-amber ring-offset-2 ring-offset-[#09090b] scale-105 z-10';
            title = `روز ${toPersianDigits(dayNumber)} (امروز): کمال تعهد ۱۰ از ۱۰ (۵ پایه + ماموریت ویژه)`;
          } else {
            bgClass = 'bg-emerald text-black border-emerald font-bold shadow-subtle ring-2 ring-emerald ring-offset-2 ring-offset-[#09090b] scale-105 z-10';
          ...
          bgClass = 'bg-blue text-white border-blue ring-2 ring-blue ring-offset-2 ring-offset-[#09090b] scale-105 z-10';
          ...
          bgClass = 'surface-z2 text-role-primary border-standard ring-2 ring-amber ring-offset-2 ring-offset-[#09090b] font-black scale-105 z-10 shadow-subtle';
        ...
        if (computed.statusType === 'standard') {
          if (computed.score === 10) {
            ...
            bgClass = 'bg-amber text-black border-amber font-black shadow-subtle ring-1 ring-amber-subtle';
            ...
            bgClass = 'bg-emerald text-black border-emerald font-bold shadow-subtle';
          ...
          bgClass = 'bg-blue text-white border-blue';
    ...
    <div className="w-full max-w-full surface-z1 border-standard radius-card sm:radius-modal p-3.5 sm:p-5 md:p-7 shadow-subtle space-y-4 sm:space-y-5 overflow-hidden" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 sm:gap-4 border-b border-standard pb-3.5 sm:pb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="surface-z2 border-standard text-role-secondary text-[10px] px-2.5 py-0.5 rounded-full font-bold select-none pointer-events-none cursor-default font-mono shrink-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-[11px] text-role-secondary flex-wrap">
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-amber-subtle text-amber select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full bg-amber shadow-subtle shrink-0"></span>
            <span className="whitespace-nowrap leading-none">کمال ۱۰/۱۰ (با ماموریت ویژه)</span>
          </div>
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-emerald-subtle text-emerald select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald shadow-subtle shrink-0"></span>
          ...
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-standard text-role-primary select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full surface-z3 ring-1 ring-amber shrink-0"></span>
            <span className="whitespace-nowrap leading-none">امروز در حال نبرد</span>
          </div>
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-blue-subtle text-blue select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full bg-blue shrink-0"></span>
            <span className="whitespace-nowrap leading-none">فریز اضطراری</span>
          </div>
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-debt-subtle text-debt select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full bg-debt animate-pulse shrink-0"></span>
            <span className="whitespace-nowrap leading-none">بدهی باز</span>
          </div>
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-purple-subtle text-purple select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full bg-purple shrink-0"></span>
          ...
          <div className="inline-flex items-center gap-1.5 surface-z2 px-2.5 py-1 radius-control border-standard text-role-muted select-none pointer-events-none whitespace-nowrap">
            <span className="w-2.5 h-2.5 rounded-full surface-z1 border-standard shrink-0"></span>
