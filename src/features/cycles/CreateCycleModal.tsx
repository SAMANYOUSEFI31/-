      ...
      >
        ...
        >
          ...
          <div className="px-5 sm:px-7 py-4 border-b border-standard flex items-center justify-between surface-z3 shrink-0 relative">
            <div className="flex items-center gap-3.5 pr-1 min-w-0">
              ...
              <div className="min-w-0">
                <h3 id="create-cycle-title" className="text-base sm:text-lg font-black text-role-primary flex items-center gap-2 truncate">
                  <span>تعریف چرخه ۹۰ روزه نبرد</span>
                </h3>
                <p id="create-cycle-description" className="text-xs text-role-secondary mt-0.5 truncate">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div className="p-5 sm:p-7 space-y-4 sm:space-y-5 overflow-y-auto overscroll-contain flex-1 min-h-0">
            ...
            <div className="px-5 sm:px-7 py-3.5 sm:py-4 surface-z3 border-t border-standard flex items-center justify-start gap-2.5 shrink-0">
              <button
                type="button"
                onClick={onClose}
              ...
              <button
                type="submit"
                className="btn-contract-primary px-6 py-2.5 min-h-[44px] radius-component text-xs font-bold shadow-subtle flex items-center gap-1.5 touch-manipulation focus-ring-tactical"
              >
